...
public class SalesReportGUI extends Components {
    ...
    private JLabel dateFromToLabel, totalAmntLbl, totalQuantLbl, mostPopular, leastPopular, todayLabel, mostCatPopular, leastCatPopular;
    ...
    public SalesReportGUI() {
        ...
        JLabel cName = new JLabel("Sales Report", SwingConstants.CENTER);
        ...
        centerSouthPanel.setLayout(new GridLayout(2, 6, 20, 20));
        ...
        totalQuantLbl = new JLabel("Total No. of Items Sold:", SwingConstants.LEFT);
        totalQuantLbl.setFont(Components.b13);
        ...
        centerSouthPanel.add(totalQuantLbl);
    ...
    public JPanel getSalesReportGUI() {
        return mainPanel;
    }
    ...
    /**
     * Load the “paid” summary between two dates (inclusive).
     */
    private void retrieveSalesReportData() {
        // 1) build the SQL with two placeholders for the dates:
        String sql = """
            SELECT
              m.MIName           AS [Menu Item],
              m.UPrice           AS [Unit Price],
              SUM(oi.Quantity)   AS [Total Quantity Sold],
              SUM(oi.TotalPrice) AS [Generated Amount]
            FROM ORDERITEM oi
    ...
    private int fetchTotalQuantity(java.sql.Date sqlFrom, java.sql.Date sqlTo) throws SQLException {
        String sql = """
    ...
    private void fetchSouthSummaryData(java.sql.Date sqlFrom, java.sql.Date sqlTo) throws SQLException {
        ...
        totalQuantLbl.setText("Total No. of Items Sold: " + fetchTotalQuantity(sqlFrom, sqlTo));
